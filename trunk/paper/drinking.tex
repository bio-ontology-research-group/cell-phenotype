...
\author[Hoehndorf et al.]{Robert Hoehndorf$^1$ and Midori
  A. Harris$^3$ and ... and Gabriella Rustici$^2$ and Georgios
  V. Gkoutos$^{1}$}
...
ontologies. Biological processes and functions are linked to the
physiology which the components of biological systems exhibit and 
