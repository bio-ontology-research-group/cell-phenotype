...
domain to achieve this goal \cite{Hoehndorf2009sequences,
  rnao}. On the other hand, automated reasoning over large ontologies
and associated datasets benefits from languages with a low complexity
of inferences in which complex axioms cannot be formulated. Therefore,
we use a layered approach: we specify the meaning of terms

although OWL has high expressivity, some things
